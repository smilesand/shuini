...
def _build_uhpc_sheet(ws, name: str, flat: dict[str, Any]) -> None:
    ...
    row += 1
    _write_filled_row(ws, row, [grade, _num(_first(flat, "req_spread", "reqSpread"), 0), _num(_first(flat, "tensile_strength", "fiber_strength_grade", "fiberStrengthGrade"), 1), ""], VALUE_FILL)
    row += 2
